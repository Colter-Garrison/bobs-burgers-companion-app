		...
		<>
			...
			<ScrollView className='flex-1 bg-bbGreen'>
				<View className='flex-col items-center gap-[10px] p-[16px]'>
					...
					<View className='w-full max-w-[420px] items-center gap-[10px] rounded-lg border-4 border-bbRed bg-bbYellow p-[16px]'>
						{image ? (
							<Image
						...
						<Text className='font-chewy text-center text-[24px] text-bbRed'>
							{name}
						</Text>
						<Text className='font-chewy text-center text-[16px] text-bbRed'>
							{bio}
						</Text>
						{fandomUrl ? (
							<Pressable
