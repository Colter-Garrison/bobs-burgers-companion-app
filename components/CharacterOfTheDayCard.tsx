...
export function CharacterOfTheDayCard({
	...
	return (
		<View className='flex-1 items-center justify-center p-[10px]'>
			<View className='max-w-[320px] items-center gap-[10px] rounded-lg border-4 border-bbRed dark:border-darkAccent bg-bbYellow dark:bg-darkSurface p-[16px]'>
				...
				<Text className='font-chewy text-center text-[22px] text-bbRed dark:text-darkAccent'>
					{character.name}
				</Text>
				<Text className='font-chewy text-center text-[14px] text-bbRed dark:text-darkAccent'>
					{blurb}
				</Text>
			</View>
		</View>
